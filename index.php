...
if (!empty($_POST['send'])) {
    ...
    // Assign variables with null coalescing
    $name = $input['name'] ?? '';
    $email = $input['email'] ?? '';
            ...
            <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                        ...
                        <div class="p-5 lg:p-10 rounded bg-gray-100">
                            <div class="mb-5">
                                ...
                                <p class="mt-4 text-gray-500">
                                    Have questions or feedback? We'd love to hear from you! Fill out the form below to
                    ...
                    <div class="rounded">
                        <div class="rounded">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15474.732619958557!2d121.32509100000001!3d14.154716!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bd5f36a2223d53%3A0xe436a7bc94d7554d!2sKAPE%20Milagrosa!5e0!3m2!1sen!2sph!4v1758873496270!5m2!1sen!2sph"
