                    ...
                    <div>
                            ...
                            <?php if (!empty($product['ingredients'])): ?>
                                ...
                                <div class="modal-products text-muted small">
                                    <?php foreach ($product['ingredients'] as $ingredient): ?>
                                        <?= htmlspecialchars($ingredient['name']) ?> : <?= htmlspecialchars($ingredient['level']) ?>
                                        </br>
                                    <?php endforeach; ?>
                                </div>
                        ...
                        <div class="modal-products text-muted small">
                            ...
                            if ($order['type'] == 'coffee') {
                                $total = ($product['price'] + $product['cup_sizes']['price']) * $product['quantity'] + array_sum(array_column($product['add_ons'], 'price')) * $product['quantity'];
                            }
                            ?>
                            ₱<?= number_format($total, 2) ?>
                        </div>
