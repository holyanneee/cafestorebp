...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <?php
         $total_pendings = 0;
         $select_pendings = $conn->prepare("SELECT SUM(op.price * op.quantity) AS total_price FROM order_products op JOIN orders o ON op.order_id = o.id WHERE payment_status = ?");
