...
-- Generated at: 2025-12-07 14:18:14
...
INSERT INTO `backups` VALUES ('7', 'backup_20251123_194351.sql', 'backups/backup_20251123_194351.sql', '0.01', '2025-11-24 03:43:51');
...
CREATE TABLE `cart` (
  ...
  `special_instruction` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`id`)
...
CREATE TABLE `deliveries` (
  ...
  `status` enum('pending','processing','shipped','otw','delivered','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'pending',
...
INSERT INTO `order_products` VALUES ('17', '14', '37', '2', '100.00', '260.00', '{\"1\":{\"name\":\"Sugar\",\"level\":\"Regular\"},\"2\":{\"name\":\"Ice\",\"level\":\"Regular\"},\"5\":{\"name\":\"Frappe\",\"level\":\"Extra\"}}', '{\"size\":\"Large\",\"price\":10}', '[{\"id\":\"45\",\"name\":\"\\n                           Tapioca Pearls\",\"price\":20}]', '2025-11-25 22:59:58', '2025-11-25 22:59:58');
INSERT INTO `order_products` VALUES ('18', '15', '24', '2', '100.00', '260.00', '{\"1\":{\"name\":\"Sugar\",\"level\":\"extra\"},\"2\":{\"name\":\"Ice\",\"level\":\"regular\"},\"5\":{\"name\":\"Frappe\",\"level\":\"extra\"}}', '{\"size\":\"large\",\"price\":10}', '{\"45\":{\"name\":\"Tapioca Pearls\",\"price\":20}}', '2025-11-25 23:11:11', '2025-11-25 23:11:11');
...
CREATE TABLE `orders` (
  ...
  `type` enum('coffee','religious') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `delivery_fee` int NOT NULL DEFAULT '0',
  `updated_by_cashier` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `updated_by_barista` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `receipt` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `orders` VALUES ('14', '38', 'Walk-in Customer', '', '', 'cash', 'N/A', 'preparing', 'coffee', '0', 'admin1', NULL, '', '1', '2025-11-25 14:59:58', '2025-11-25 22:59:58', '2025-11-25 22:59:58');
INSERT INTO `orders` VALUES ('15', '50', 'Roy Joseph Mendoza Latayan', '09512370553', 'royjosephlatayan16@gmail.com', 'cash on delivery', 'Tran and Phelps LLC, Lamot 2, Calauan', 'pick-up', 'coffee', '10', NULL, NULL, NULL, '0', '2025-12-06 14:15:11', '2025-11-25 23:11:11', '2025-12-06 14:15:11');
...
CREATE TABLE `wishlist` (
  ...
  `user_id` int NOT NULL,
  `product_id` int NOT NULL,
  `type` enum('coffee','online') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'coffee',
  PRIMARY KEY (`id`)
